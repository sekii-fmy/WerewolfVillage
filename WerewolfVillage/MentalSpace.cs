                ...
                if (getAgent(data.Guess).coRole[1])
                {
                    for (int i = 0; i < Form1.num_villager; i++)
                    {
                        if (mentalAgentList[i].alive && mentalAgentList[i].coRole[1])
                        {
                            for (int k = 0; k < Form1.num_villager; k++)
                            {
                                mentalAgentList[k].oppositeTable.table[i, 1] -= gene.parameter[89];
                                mentalAgentList[k].oppositeTable.table[getAgentNum(data.Guess), 1] += gene.parameter[88];
                            }
                        }
                    }
                }
                else if (getAgent(data.Guess).coRole[2])
                {
                    for (int i = 0; i < Form1.num_villager; i++)
                    {
                        if (mentalAgentList[i].alive && mentalAgentList[i].coRole[2])
                        {
                            for (int k = 0; k < Form1.num_villager; k++)
                            {
                                mentalAgentList[k].oppositeTable.table[i, 2] -= gene.parameter[89];
                                mentalAgentList[k].oppositeTable.table[getAgentNum(data.Guess), 2] += gene.parameter[88];
                            }
                        }
                    }
                }
                else if (getAgent(data.Guess).coRole[3])
                {
                    for (int i = 0; i < Form1.num_villager; i++)
                    {
                        if (mentalAgentList[i].alive && mentalAgentList[i].coRole[3])
                        {
                            for (int k = 0; k < Form1.num_villager; k++)
                            {
                                mentalAgentList[k].oppositeTable.table[i, 3] -= gene.parameter[89];
                                mentalAgentList[k].oppositeTable.table[getAgentNum(data.Guess), 3] += gene.parameter[88];
                            }
                        }
                    }
                }
